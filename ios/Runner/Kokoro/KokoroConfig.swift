...
// Apache License 2.0. MODIFIED by Halfmarble LLC: KokoroOutput added here,
// rehomed unchanged from upstream's MLX-dependent KModel.Output.
//
...
/// What one synthesis pass returns. Upstream this is `KModel.Output`, which
/// lives in the MLX half of the package; SteadyHeartBeat vendors only the
/// Core ML half, so it is rehomed here unchanged.
public struct KokoroOutput: Sendable {
