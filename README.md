...
1. **Prior art (public domain).** Selected *methods and techniques* are disclosed as dated, public-domain **defensive publications** — **[PRIOR_ART_EARBUD_CLOSED_LOOP.md](PRIOR_ART_EARBUD_CLOSED_LOOP.md)** and **[PRIOR_ART_REST_GATING.md](PRIOR_ART_REST_GATING.md)** (effective 2026-06-02). Publishing them as prior art keeps them freely practicable by anyone and prevents third parties from patenting them. That is their only purpose — they do **not** give away the source code or the application.
